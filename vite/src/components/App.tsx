	...
	return (
		<div id={theme}>
			...
			<div className='menu container'>
				<Button style={{background:"#1B98E0",color:"white",letterSpacing:"0.1rem"}} label='Sketch' icon='pi pi-arrow-circle-right' />
			...
			<div className='control--bars container'>
				...
				<Button style={{background:"#1B98E0",color:"white",letterSpacing:"0.1rem"}} label='Switch' />
			</div>
